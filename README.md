...
session mid-game). Set `ARENA_AGENT_RESET_BETWEEN_GAMES=0` to instead keep one session for the
whole run. They are reference implementations of using agent frameworks as social-deduction players.

...
def act(turn):
    if turn.action_kind == "onuw.discussion.speak_or_pass":
        return {
            ...
            "declared_reasoning": "Role-claiming baseline makes a strong public claim even with weak evidence.",
        }
    if turn.action_kind == "onuw.vote":
        ...
        return {"action": {"target": target}, "declared_reasoning": "Vote against the last legal participant to anchor the claim."}
